...
- The `landing/` app is the GitHub Pages marketing and documentation site (Vite, React, TypeScript, Tailwind CSS 4, Headless UI, atomic design); primary docs are authored as **MDX** with frontmatter-style metadata for navigation and page titles.
