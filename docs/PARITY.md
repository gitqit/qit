...
- The session username and password expire when the serving process exits, and are written to a local file by default instead of always being printed to stdout.
